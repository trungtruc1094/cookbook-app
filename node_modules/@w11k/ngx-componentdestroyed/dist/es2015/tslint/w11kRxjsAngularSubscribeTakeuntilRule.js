...
function getClassesWithAnnotation(sourceFile, annotationName) {
    var componentAnnotations = tsquery(sourceFile, "ClassDeclaration Decorator CallExpression Identifier[name='" + annotationName + "']");
...
function hasImport(sourceFile, moduleName, namedImport) {
    ...
    var angularCoreImports = tsquery(sourceFile, "ImportDeclaration StringLiteral[value='" + moduleName + "']");
    angularCoreImports.forEach(function (stringLiteral) {
        var componentImports = tsquery(stringLiteral.parent, "NamedImports Identifier[name='" + namedImport + "']");
...
var Rule = /** @class */ (function (_super) {
    ...
    Rule.prototype.applyWithProgram = function (sourceFile, program) {
        ...
        relevantClasses.forEach(function (classDeclaration) {
            var propertyAccessExpressions = tsquery(classDeclaration, "CallExpression PropertyAccessExpression[name.name=\"subscribe\"]");
